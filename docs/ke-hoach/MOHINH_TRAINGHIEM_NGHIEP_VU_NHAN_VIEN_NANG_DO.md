...
# 🎬 KỊCH BẢN 4: ĐỒNG ĐỘI NHẬN CỨU VIỆN K4 ➔ HỆ THỐNG TỰ ĐỘNG CHUYỂN TIẾP K5 VỀ CHO THỢ CHÍNH

### 4.1. Phản ứng trên Bể việc của toàn công ty:
- Trên Bể việc xuất hiện ngay thẻ đỏ cứu viện:
```
┌────────────────────────────────────────────────────────┐
│ 🆘 CA CỨU VIỆN: [K04] SOẠN HỒ SƠ KỸ THUẬT · HĐ 011    │
│ 📁 Khách hàng: Chị Hạnh · 📍 P. Phú Mỹ, Quận 7         │
│ 👤 Thợ nhường: Nguyễn Văn A (Lý do: Đi công tác khẩn)   │
│ 📄 Dữ liệu kế thừa: Đã có sẵn bản vẽ K03 & tọa độ K02  │
│ 💰 KHOÁN NHẬN NGAY: 150.000 đ · ⏱ SLA: 3 giờ           │
│                                                        │
│            👉 [ 🆘 NHẬN CỨU VIỆN & SOẠN K04 (150k) ]   │
└────────────────────────────────────────────────────────┘
```

### 4.2. Khi đồng đội B (Trần Văn B) bấm nhận và hoàn thành K4:
1. Tiền khoán `150.000 đ` của bước K4 được cộng vào bảng lương của **Trần Văn B**.
2. **Hệ thống tự động chuyển tiếp bước [K05] về lại bàn làm việc của Nguyễn Văn A** (vì ban đầu Nguyễn Văn A là người nhận trọn chuỗi K1-K5 của Hạng mục này, Nguyễn Văn A chỉ xin hỗ trợ đúng node K4 mà thôi).
3. Nguyễn Văn A tiếp tục làm bước K5 để hoàn thành hợp đồng (trừ khi Nguyễn Văn A lại chủ động bấm gửi nốt K5 lên Bể việc xin hỗ trợ).
