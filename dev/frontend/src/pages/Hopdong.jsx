...
import { Modal, FormRow, FormGrid, DataTable, StatusBadge } from '../components/ui';
...
export default function Hopdong() {
  ...
  const fetchContracts = async () => {
    try {
      const res = await fetch('http://127.0.0.1:8080/api/hopdong');
      if (res.ok) {
  ...
  const columns = [
    ...
    { key: 'Tên khách hàng', label: 'Khách hàng' },
    {
