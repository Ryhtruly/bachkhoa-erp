...
def serialize_employee(employee: Employee, department_name: str = None, account=None) -> dict:
    ...
    return {
        ...
        "citizen_id_date": employee.citizen_id_date.strftime("%Y-%m-%d") if getattr(employee, "citizen_id_date", None) else "",
        "citizen_id_place": employee.citizen_id_place or "",
        ...
        "social_insurance_no": employee.social_insurance_no or "",
