...
class WorkItem(Base):
    ...
    default_unit = Column(String, nullable=False, default="job", server_default=text("'job'"))
...
class WorkItemRate(Base):
    ...
    approval_source = Column(String, nullable=False, default="manual", server_default=text("'manual'"))
