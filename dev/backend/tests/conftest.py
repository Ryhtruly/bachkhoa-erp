...
def _ensure_runtime_tables_and_columns(connection):
    ...
    table_statements = [
        ...
        CREATE TABLE IF NOT EXISTS {p}legal_dossiers (
            ...
            closed_at {ts_type},
            closed_note TEXT,
            first_accepted_at {ts_type},
            total_pending_seconds NUMERIC,
            pending_since {ts_type},
            created_by VARCHAR,
            created_at {ts_now},
            updated_at {ts_now}
        );
    ...
    if is_pg:
        alter_statements.extend([
            ...
            f"ALTER TABLE {p}legal_dossiers ADD COLUMN IF NOT EXISTS closed_at {ts_type}",
            f"ALTER TABLE {p}legal_dossiers ADD COLUMN IF NOT EXISTS closed_note TEXT",
            f"ALTER TABLE {p}legal_dossiers ADD COLUMN IF NOT EXISTS first_accepted_at {ts_type}",
