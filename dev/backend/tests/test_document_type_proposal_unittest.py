...
class HoSoPhapLyDocQuaLienKetTests(unittest.TestCase):
    ...
    def test_truy_van_di_qua_o_giay_cua_dung_hang_muc(self):
        ...
        src = open(ROOT_SRC / "dossiers/documents.py", encoding="utf-8").read()
...
class ChuaDuyetKhongLotVaoHoSoTests(unittest.TestCase):
    ...
    def test_duong_1_cau_truc_tai_lieu_hop_dong(self):
        ...
        src = open(ROOT_SRC / "dossiers/register.py", encoding="utf-8").read()
    ...
    def test_duong_2_ho_so_do_ve(self):
        ...
        """
        src = open(ROOT_SRC / "routes/routes_survey_records.py", encoding="utf-8").read()
    ...
    def test_tep_de_xuat_khong_co_ba_thu_lam_no_chinh_thuc(self):
        ...
        src = open(ROOT_SRC / "dossiers/slot_requests.py", encoding="utf-8").read()
...
class ChotChanCamOMoiDuongTests(unittest.TestCase):
    ...
    @staticmethod
    def _src(path):
        return open(ROOT_SRC / "dossiers" / path, encoding="utf-8").read()
    ...
    def test_moi_lenh_tao_link_deu_nam_sau_mot_chot(self):
        ...
        tong_insert = (docs + reg + slot).count("insert into dossier_document_links") + (docs + reg + slot).count("insert into public.dossier_document_links")
...
class ThuTuCommitRoiMoiPublishTests(unittest.TestCase):
    ...
    def _than(ten_ham):
        ...
        src = open(ROOT_SRC / "routes/routes_slot_requests.py", encoding="utf-8").read()
